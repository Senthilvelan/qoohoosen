package  com.qoohoosen.widget.glass
...
class GlassContainerLayout : FrameLayout {
    ...
    private fun setupStyleable(context: Context, attrs: AttributeSet?) {
        ...
        this.blurAmount = typedArray.getInteger(
            R.styleable.GlassContainerLayout_glassContainerLayout_blurAmount,
            Blur.NORMAL.amount
        )
        this.sampleSize = typedArray.getInteger(
            R.styleable.GlassContainerLayout_glassContainerLayout_blurSampleSize,
