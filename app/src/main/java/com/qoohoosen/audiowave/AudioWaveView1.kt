...
//
//class AudioWaveView1 : View {
//
//    @JvmOverloads
//    constructor(context: Context?, waveBitmap: Bitmap) : super(context) {
//        setWillNotDraw(false)
//        this.waveBitmap = waveBitmap
//    }
//
//    @JvmOverloads
//    constructor(context: Context?, attrs: AttributeSet?, waveBitmap: Bitmap) : super(
//        context,
//        attrs
//    ) {
...
//        set(value) {
//            require(0 <= value && value <= 100) { "Progress must be in 0..100" }
//
//            field = Math.abs(value)
//
